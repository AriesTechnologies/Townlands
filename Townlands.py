...
World = pygame.image.load("./Images/World.png")
World2 = pygame.image.load("./Images/WorldNight.png")
Sun = pygame.image.load("./Images/Sun.png")
Moon = pygame.image.load("./Images/Moon.png")
RedMoon = pygame.image.load("./Images/RedMoon.png")
Portal = pygame.image.load("./Images/Portal.png")
TownHall = pygame.image.load("./Images/TownHall.png")
TownHall2 = pygame.image.load("./Images/TownHall2.png")
TownHall3 = pygame.image.load("./Images/TownHall3.png")
Shop = pygame.image.load("./Images/Shop.png")
Prince = pygame.image.load("./Images/Prince.png")
LPrince = pygame.image.load("./Images/PrinceLeft.png")
Tree = pygame.image.load("./Images/Tree.png")
Wall = pygame.image.load("./Images/Wall.png")
Wall2 = pygame.image.load("./Images/Wall2.png")
Statue = pygame.image.load("./Images/Statue.png")
Statue2 = pygame.image.load("./Images/Statue2.png")
Cannon = pygame.image.load("./Images/Cannon.png")
Cannon2 = pygame.image.load("./Images/Cannon2.png")
Cannon3 = pygame.image.load("./Images/Cannon3.png")
ArcherTower = pygame.image.load("./Images/ArcherTower.png")
ArcherTower2 = pygame.image.load("./Images/ArcherTower3.png")
ArcherTower3 = pygame.image.load("./Images/ArcherTower2.png")
PauseMenu = pygame.image.load("./Images/PauseMenu.png")
Tree1 = pygame.image.load("./Images/Tree.png")
Waterfall = pygame.image.load("./Images/Waterfall.png")
Farm = pygame.image.load("./Images/Farm.png")
Farm2 = pygame.image.load("./Images/Farm2.png")
AtlasFlag = pygame.image.load("./Images/AtlasCorpFlag.png")
RedFlag = pygame.image.load("./Images/RedFlag.png")
RedBanner = pygame.image.load("./Images/RedBanner.png")
RedBannerClan = pygame.image.load("./Images/RedBannerClan.png")
YellowFlag = pygame.image.load("./Images/YellowFlag.png")
YellowBanner = pygame.image.load("./Images/YellowBanner.png")
YellowBannerClan = pygame.image.load("./Images/YellowBannerClan.png")
GreenFlag = pygame.image.load("./Images/GreenFlag.png")
GreenBanner = pygame.image.load("./Images/GreenBanner.png")
GreenBannerClan = pygame.image.load("./Images/GreenBannerClan.png")
BlueFlag = pygame.image.load("./Images/BlueFlag.png")
BlueBanner = pygame.image.load("./Images/BlueBanner.png")
BlueBannerClan = pygame.image.load("./Images/BlueBannerClan.png")
PurpleFlag = pygame.image.load("./Images/PurpleFlag.png")
PurpleBanner = pygame.image.load("./Images/PurpleBanner.png")
PurpleBannerClan = pygame.image.load("./Images/PurpleBannerClan.png")
PinkFlag = pygame.image.load("./Images/PinkFlag.png")
PinkBanner = pygame.image.load("./Images/PinkBanner.png")
PinkBannerClan = pygame.image.load("./Images/PinkBannerClan.png")
RedFlagStar = pygame.image.load("./Images/RedFlagRedStar.png")
RedStarBanner = pygame.image.load("./Images/RedStarBanner.png")
RedStarBannerClan = pygame.image.load("./Images/RedStarBannerClan.png")
GreenFlagStar = pygame.image.load("./Images/GreenFlagRedStar.png")
GreenStarBanner = pygame.image.load("./Images/GreenStarBanner.png")
GreenStarBannerClan = pygame.image.load("./Images/GreenBannerClan.png")
BlueFlagStar = pygame.image.load("./Images/BlueFlagRedStar.png")
StarryNightFlag = pygame.image.load("./Images/StarryNightFlag.png")
NASAFlag = pygame.image.load("./Images/NASAFlag.png")
JacksepticeyeBanner = pygame.image.load("./Images/JacksepticeyeBanner.png")
JacksepticeyeBannerClan = pygame.image.load("./Images/JacksepticeyeBannerClan.png")
...
def SaveFile():
    ...
    File = open("./Saves/savefile.txt", "w")
...
try:
    with open("./Saves/savefile.txt") as File:
        D0 = File.readline()
...
try:
    with open("./version.txt") as File3:
        VD0 = File3.readline()
        Version = str(VD0)
        VD1 = File3.readline()
...
def SaveFile2():
    File2 = open("./pastversionsinfo.txt", "w")
